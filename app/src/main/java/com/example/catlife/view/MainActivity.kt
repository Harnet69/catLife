...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cat_get_btn.setOnClickListener { fetchCatFacts(call) }
    }

    private fun fetchCatFacts(call: Call<List<CatFact>>){
        onLoading()
    ...
    private fun onSuccess(catFactsList: List<CatFact>?) {
        err_msg.visibility = View.GONE
        loading_progress_bar.visibility = View.GONE
        Log.i("resultCatFacts", "onResponse: $catFactsList")
        cat_info.apply {
